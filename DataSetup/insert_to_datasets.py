...
try:
    ...
    for index, row in df.iterrows():
        tags_array = row['Tags'].split(',')  # Split the string into a list
        ...
        insert_query = sql.SQL('''
            INSERT INTO datasets (link, description, tags, data_type, data_size_mb, number_of_rows, date_posted, language)
